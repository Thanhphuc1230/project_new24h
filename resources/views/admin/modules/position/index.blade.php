                                            ...
                                            @php
                                                if ($item->status_position == 0) {
                                                    if (session('admin_check')) {
                                                        echo '<a onclick="return confirm(\'Xác nhận kích hoạt chức vụ ?\')"href="' . route('admin.position.status_position', ['uuid' => $item->uuid, 'status' => 1]) . '"class="status_btn" style="background:#FA8072!important">Unactive</a>';
                                                    } else {
                                                    ...
                                                    if (session('admin_check')) {
                                                        echo '<a onclick="return confirm(\'Xác nhận tắt kích hoạt chức vụ ?\')"href="' . route('admin.position.status_position', ['uuid' => $item->uuid, 'status' => 0]) . '"class="status_btn">Active</a>';
                                                    } else {
                                        ...
                                        <td>
                                            <div class="action_btns d-flex">
                                                @php
                                                    if (session('admin_check')) {
                                                        echo '<a href="' .
                                                            route('admin.position.edit', ['uuid' => $item->uuid]) .
                                                            '" class="action_btn mr_10">
                                                        <i class="far fa-edit"></i>
                                                    </a>';
                                                        echo '<a onclick="return confirm(\'Xác nhận xóa nhãn hàng ?\')"
                                                        href="' .
                                                            route('admin.position.destroy', ['uuid' => $item->uuid]) .
                                                            '" class="action_btn">
